      ...
      <div className="p-6 flex flex-col flex-grow" style={{ background: "#FFFBF5" }}>
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          {isAvailable ? (
            ...
            <span className="px-5 py-2.5 text-sm font-bold rounded-full"
...
export default function ResortRooms() {
  ...
  return (
    <>
      <Header />
      <div className="w-full min-h-full" style={{ background: "#FAF7F2" }}>
        ...
        <div className="relative w-full overflow-hidden" style={{ minHeight: 360 }}>
          <div
            ...
            style={{
              backgroundImage:
                "url('https://www.alba-hotel.com/img/rooms/hotel-alba-roomtypes-deluxe-1.jpg?v=6.06.24')",
          ...
          >
            <p className="text-xs font-bold uppercase tracking-[0.3em] mb-3" style={{ color: "#FBBF24" }}>
              RESORT &amp; SAFARI
            </p>
            <h1
            ...
            >
              Resort <span style={{ color: "#FBBF24" }}>Rooms</span>
            </h1>
            <p className="text-base sm:text-lg max-w-xl" style={{ color: "rgba(255,255,255,0.75)" }}>
        ...
        <div style={{ background: "linear-gradient(135deg,#FEF3C7,#FDE8C8)" }} className="px-6 py-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div
              ...
              style={{
                ...
                boxShadow: "0 8px 40px rgba(217,119,6,0.13)",
                border: "1.5px solid rgba(251,191,36,0.25)",
              }}
            >
              <p className="text-xs font-bold uppercase tracking-[0.2em] mb-5 text-center" style={{ color: "#92400E" }}>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-4">
                ...
                <div className="flex-1 flex flex-col gap-2">
                  <label className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest" style={{ color: "#92400E" }}>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-2xl text-sm font-semibold outline-none transition-all duration-200"
                      style={{
                        background: "#FFFBF5",
                      ...
                      onFocus={e => e.target.style.boxShadow = "0 0 0 3px rgba(251,191,36,0.35)"}
                      onBlur={e => e.target.style.boxShadow = "0 2px 8px rgba(217,119,6,0.08)"}
                    />
                  </div>
                </div>

                {/* Arrow divider */}
                <div className="hidden sm:flex items-end pb-3.5 text-amber-400 text-xl font-bold select-none">→</div>
                ...
                <div className="hidden sm:flex flex-col gap-2">
                  <label className="text-xs font-bold uppercase tracking-widest opacity-0">dur</label>
                  <div
                  ...
                  >
                    <span className="text-xl font-black leading-none" style={{ color: "#D97706" }}>{nights}</span>
                    <span className="text-[10px] font-bold uppercase tracking-wider mt-0.5" style={{ color: "#A8A29E" }}>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <button
                    ...
                    disabled={searching}
                    className="flex items-center justify-center gap-2.5 px-8 py-3 rounded-2xl font-bold text-sm transition-all duration-200 hover:-translate-y-0.5 active:scale-95"
                    style={{
                      ...
                      boxShadow: searching ? "none" : "0 4px 16px rgba(245,158,11,0.4)",
                      minWidth: 180,
                    }}
                  >
                    {searching ? (
              ...
              {searchDone && (
                <div className="flex items-center justify-center gap-3 mt-5 pt-5" style={{ borderTop: "1px solid #F5EACF" }}>
                  {searchResults.length === 0 ? (
                    ...
                    <span className="flex items-center gap-2 text-sm font-semibold px-4 py-2 rounded-full"
                      ...
                      ✅ {searchResults.length} room{searchResults.length !== 1 ? "s" : ""} available
                    </span>
                  )}
                  <button
                    onClick={clearSearch}
                    className="text-xs font-bold px-4 py-2 rounded-full border transition-all hover:bg-amber-50"
          ...
          {searching && (
            <div className="w-full flex flex-col items-center justify-center py-20 gap-4">
              ...
              <p className="text-sm font-semibold" style={{ color: "#78716C" }}>
                Checking availability for {checkIn} → {checkOut}…
              </p>
            </div>
          )}
