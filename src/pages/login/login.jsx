...
export default function LoginPage() {
    ...
    return (
        <div className="bg-picture w-full min-h-screen flex justify-center items-center p-4 sm:p-6">
            <form onSubmit={handleOnSubmit} className="w-full max-w-md">
                <div className="glass-container w-full rounded-3xl flex justify-center items-center flex-col p-6 sm:p-8 shadow-2xl">

                    {/* Logo */}
                    <div className="logo-wrapper mb-6 sm:mb-8 transform transition-transform duration-300 hover:scale-105">
                        <img
                            src="123.webp"
                            alt="logo"
                            className="w-20 h-20 sm:w-24 sm:h-24 object-cover rounded-full ring-4 ring-white/30 shadow-lg"
                        />
                    </div>
                    ...
                    {/* Email Input */}
                    <div className="input-group w-full mb-4 sm:mb-6">
                        ...
                        <div className="relative">
                            <input
                                ...
                                autoComplete="email"
                                inputMode="email"
                                className="input-field w-full h-12 sm:h-12 px-4 pr-12 bg-white/10 border-2 border-white/30
                            ...
                            />
                            <svg
                                className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/50 pointer-events-none"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
                    ...
                    <div className="input-group w-full mb-4 sm:mb-6">
                        ...
                        <div className="relative">
                            <input
                                ...
                                required
                            />
                            {/* Toggle show/hide — 44×44 touch target */}
                            <button
                                type="button"
                                ...
                                className="absolute right-2 top-1/2 -translate-y-1/2
                                         ...
                                         rounded-lg focus:outline-none focus:ring-2 focus:ring-[#efac38]/60"
                            >
                                {showPassword ? (
                    ...
                    <div className="w-full flex justify-between items-center mb-6 sm:mb-8">
                        <label className="flex items-center cursor-pointer group gap-2">
                            <input
                                type="checkbox"
                                className="w-[18px] h-[18px] rounded border-2 border-white/30 bg-white/10
                                         checked:bg-[#efac38] checked:border-[#efac38]
                                         focus:ring-2 focus:ring-[#efac38]/50 cursor-pointer flex-shrink-0"
                            />
                            <span className="text-white/80 text-sm group-hover:text-white transition-colors select-none">
                                Remember me
                            </span>
                        </label>
                        <a
                            ...
                            className="text-[#efac38] text-sm hover:text-[#ffb84d] transition-colors
                                     hover:underline underline-offset-2 py-1 px-1 -mr-1"
                        >
                            Forgot Password?
                        </a>
                    </div>
                    ...
                    <div className="w-full flex flex-row gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="flex-1 h-12 sm:h-12 bg-gradient-to-r from-[#efac38] to-[#ffb84d]
                        ...
                        >
                            {isLoading ? (
                                <>
                                    <svg className="animate-spin h-5 w-5 text-gray-500 flex-shrink-0" viewBox="0 0 24 24">
                                        <circle className="opacity-25" cx="12" cy="12" r="10"
                                            stroke="currentColor" strokeWidth="4" fill="none" />
                                        <path className="opacity-75" fill="currentColor"
                                            d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
